...
<body>
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="index.php">Login Sample</a></li>
				</ul>
			</div>
		</div>
	</nav>
	<div class="container">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<pre><?php echo $openApiResponseData ?></pre>
			</div>
		</div>
	...
	<a href="index.php" class="btn btn-primary">Reload Page</a>
	</div>

	<form style="display: none" id="samlForm" action="<?php echo $authenticationUrl ?>" method="POST">
